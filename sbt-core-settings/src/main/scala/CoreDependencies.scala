...
trait CoreDependencies {
  ...
  val allenAiCommon = "org.allenai.common" %% "common-core" % "2014.09.09-0"
  val allenAiTestkit = "org.allenai.common" %% "common-testkit" % "2014.09.09-0"
  val allenAiWebapp = "org.allenai.common" %% "common-webapp" % "2014.09.09-0"
