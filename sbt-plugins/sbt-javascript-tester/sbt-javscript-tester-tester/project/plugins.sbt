...
lazy val root = Project("plugins", file(".")).dependsOn(plugin, sharedPlugin)

lazy val plugin = ProjectRef(file("../../").getCanonicalFile.toURI, "sbtJavascriptTester")

lazy val sharedPlugin = ProjectRef(file("../../").getCanonicalFile.toURI, "sbtSharedUi")
